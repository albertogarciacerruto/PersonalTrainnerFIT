  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="site-section-heading text-center">Planes de Entrenamiento</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12 block-13 nav-direction-white">
            ...
            @foreach($plans as $plan)
              <div class="media-image">
                <img src="../storage/app/{{$plan->image}}" alt="Image" class="img-fluid">
    ...
    <div class="site-section">
      <div class="row">
        <div class="col-md-12">
          <h2 class="site-section-heading text-center">Tendras a Disposición</h2>
        </div>
      </div>
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <p class="mb-5"><img src="../storage/app/{{$offer->image}}" alt="Image" class="img-fluid"></p>
          </div>
          <div class="col-lg-5 ml-auto">
            <h2 class="site-section-heading mb-3">{{ $offer->title }}</h2>
            <p>{{ $plan->body }}</p>
            <p><a href="{{ route('register') }}" class="btn btn-outline-primary py-2 px-4">Registrate</a></p>
          </div>
        </div>
        @endforeach
      </div>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="site-section-heading text-center">Areas Funcionales</h2>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-12 block-13 nav-direction-white">
            <div class="nonloop-block-13 owl-carousel">
              ...
              <div class="media-image">
                <img src="../storage/app/{{$area->image}}" alt="Image" class="img-fluid">
                <div class="media-image-body">
                  <h2>{{ $area->title }}</h2>
                  <p>{{ $area->body }}</p>
                </div>
